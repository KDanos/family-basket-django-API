"""
Django settings for family_basket project.
...
# DEBUG = True : only used in development
DEBUG = env.bool('DEBUG', default=False) #debug value for production (HEROKU deployned)
...
ROOT_URLCONF = 'family_basket.urls'
...
WSGI_APPLICATION = 'family_basket.wsgi.application'
